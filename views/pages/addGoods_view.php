...
<div>
    <div class="div1">
        ...
        <div class="div3">
            <lable>请输入您要发布的物品的具体信息</lable><br>
            <div>
                <form method="get" action="../../models/addGoods.php"  onSubmit="return input(this)">
                    <table border="0">

                        <tr>
                            <td>
                                <lable>物品名</lable><br>
                                <input type="text" name="goodsName" size="60%"><br><br>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <lable>出售价格</lable>
                                <input type="text" name="price" size="15px">元<br><br>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <lable>物品数量</lable>
                                <input type="text" name="number" size="15px">件<br><br>
                            </td>
                        </tr>
                        <tr>
                            <td>
