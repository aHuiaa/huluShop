...
<title>葫芦二手交易网</title>
<div class="div1">
    <form name="login" method="post" action="../../models/login.php" onSubmit="return input(this)">
        <div class="div2">
            <h2 align="center" >欢迎登录葫芦二手交易网！</h2>
            <h2 style="color: #1c94c4;font-size: xx-large">用户登录</h2>
            <div >
                账号：<input name="id" type="text" size="50" placeholder="请输入注册时的学号/工号！" class="l_form-control">
                <br>
            </div>
            <div>
